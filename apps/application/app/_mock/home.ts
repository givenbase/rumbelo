...
export const mockCoach = [
    {
        id: 'c1',
        kind: 'NUDGE',
        text: 'Six transactions are waiting for a jar. Ten minutes and your overview is right again.',
        ctaLabel: 'Sort inbox',
        ctaHref: '/money/transactions',
    },
    {
        id: 'c2',
        kind: 'WIN',
        text: 'Necessity is 8% under the line this month. That is €340 you can redirect.',
        ctaLabel: 'Redirect',
        ctaHref: '/ritual',
    },
] as const;
