            ...
            <Card className="grid gap-0 p-0">
                ...
                <div className="grid gap-4 p-6">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        <span className="font-mono text-xs font-medium tracking-widest whitespace-nowrap text-fg-muted uppercase">
                            Sleep per night
                        </span>
                        <input
                            type="range"
                            ...
                            defaultValue={h}
                            readOnly
                            className="max-w-45 min-w-30 flex-1 accent-accent"
                        />
                        <span className="min-w-13 font-mono text-sm font-medium text-fg">{h}h</span>
                        <span className="rounded-full border border-success/25 bg-success/10 px-2.75 py-1.5 font-mono text-xs font-medium tracking-widest whitespace-nowrap text-success uppercase">
                            Good
                        </span>
                    </div>

                    {/* Stage colour bar */}
                    <div className="flex h-2.5 max-w-115 gap-0.5 overflow-hidden rounded-full">
                    ...
                    <p className="max-w-prose text-sm leading-relaxed text-fg-muted">
                        Two different things: deep sleep restores you, REM sleep sharpens you. Deep
                        sleep comes in the first hours of the night, REM in the last — so a short
                    ...
                    <div className="rounded-xl border border-success/25 bg-success/10 px-4 py-3.5">
                        <p className="text-sm leading-relaxed text-fg-secondary">
                            About 5.3 complete cycles — delta is at its maximum (1.7h) and your
                            REM-theta too (1.7h). Delta cannot go much higher: slow-wave is capped
                            at roughly 1.5 to 2 hours per night. Sleeping longer mainly adds more
                            theta and REM — which is exactly what you lose on a short night.
                        </p>
                    </div>

                    <p className="font-mono text-xs leading-relaxed font-medium tracking-normal text-fg-faint">
                        Rough estimate based on average sleep stages — general information, not
                        medical advice.
                    </p>
                </div>
                ...
                <div className="grid gap-3 border-t border-line px-6 py-5">
                    ...
                    <p className="max-w-prose text-sm leading-relaxed text-fg-secondary">
                        At {h} hours you pay nothing elsewhere. Your 40 steered hours arrive at full
                        power, and your Play jar stays a choice instead of a reflex.
                    </p>
                </div>
            </Card>
        </div>
