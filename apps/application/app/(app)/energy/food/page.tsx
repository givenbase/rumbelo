    ...
    return (
        <div className="grid animate-rise gap-6">
            <Section
                ...
                title={
                    headDone
                        ? 'Protein is in. The rest is detail.'
                        : `${protTarget - protToday}g protein left today.`
                }>
                ...
                {TARGETS.map(ft => (
                    <div
                        ...
                        <div className="flex flex-wrap items-baseline justify-between gap-2">
                            ...
                            <span
                                className="font-mono text-xs font-medium tracking-wide whitespace-nowrap uppercase"
                        ...
                        <div className="flex flex-wrap gap-2">
                            {ft.quick.map(q => (
                                <button
                                    key={q}
                                    type="button"
                                    className="rounded-full border border-line-strong px-3.5 py-2 font-mono text-xs font-medium tracking-wide whitespace-nowrap text-fg-secondary transition-colors hover:border-accent-hover hover:text-accent">
                                    {q}
                                </button>
                            ))}
                        </div>
