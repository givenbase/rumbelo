...
export function BoardPageClient() {
    ...
    const monthlyPassive = mockHoldings.filter(h => !h.locked).reduce((s, h) => s + h.flow, 0);
            ...
            <Card className="grid gap-5">
                <div className="flex items-end justify-between gap-4">
                    <div>
                        ...
                        <p className="mt-1.5 font-display text-4xl font-semibold text-fg tabular-nums">
                            {mockTurn.score}
                    ...
                    <ul className="divide-y divide-line">
                        {mockTurn.events.map((e, i) => (
                            <li
                                ...
                                <span className="w-8 shrink-0 text-xs text-fg-faint tabular-nums">
                                    {e.day}
                                </span>
