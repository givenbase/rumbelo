    ...
    <PageContent width="prose" className="animate-rise">
      <Section eyebrow="✦ The foundation">
        ...
        <p className="mt-4 max-w-prose text-base leading-relaxed text-fg-muted">
          Rumbelo exists for people who want to succeed — and for people who already do and want to
          keep it that way. It is not a bookkeeping app. It is one calm overview of where your
          money, your energy, and your time go, so you can adjust before life adjusts you.
        </p>
      </Section>
      ...
      <blockquote className="mt-10 font-display text-xl font-medium italic leading-relaxed tracking-tight text-fg-secondary md:text-2xl">
        &ldquo;Show me where your money and your hours go, and I will tell you where your life
        goes.&rdquo;
      </blockquote>
    </PageContent>
  );
