...
export const WHY_LINES: Record<string, string> = {
    ...
    '/energy/week': 'Your hours are your capacity. Divided on purpose, or by whoever asks loudest.',
    '/energy/sleep':
        'Sleep is the floor the jars stand on. Cut it and every other number quietly drops.',
    '/soul/mind': 'A calm mind directs money. A restless one spends it and calls that a decision.',
    '/soul/gratitude': 'Someone who sees what he already has buys less to fill a hole.',
    '/soul/intent': 'An intention is an instruction to yourself. A resolution is a hope.',
    '/soul/chakra': 'Name where it feels stuck, and the next step usually names itself.',
    '/growth/income': 'Cutting costs has a floor. Raising income does not.',
    '/growth/learn': 'A book you cannot name a use for was Play spending, not Education.',
    '/energy/train': 'Training is the only spend that raises the value of every other hour.',
    '/energy/food': 'Food is fuel for the week your jars divide. Fuel is bought, not willed.',
    '/ritual': 'Ten minutes with your coach beats worrying every day. This is the whole practice.',
    '/why': 'One line on your dashboard — not a poster, a check question when a jar gets tight.',
};
