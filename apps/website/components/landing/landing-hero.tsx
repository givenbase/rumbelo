  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        ...
        {/* Ticker */}
        <div
          className="absolute bottom-2.5 left-0 right-0 overflow-hidden"
          style={{ maskImage: 'linear-gradient(90deg, transparent, black 12%, black 88%, transparent)' }}
        >
          <div
            data-ticker
            className="inline-flex gap-10 whitespace-nowrap pr-10"
      ...
      {/* Content */}
      <div className="relative mx-auto flex max-w-6xl flex-wrap items-center gap-8 lg:gap-16 px-4 lg:px-6 py-12 lg:py-24 pb-10 lg:pb-16">
        {/* Left column */}
        <div
          className="min-w-0 min-w-0 flex-1 basis-96"
        ...
        >
          ...
          <h1 className="my-4 mb-4 max-w-xs font-display text-4xl sm:text-5xl lg:text-6xl font-semibold leading-tight tracking-tight">
            You earn fine. So where does it go?
          </h1>
          <p className="mb-7 max-w-prose text-base lg:text-lg leading-relaxed text-fg-muted">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              href="#signup"
              className="font-mono rounded-full px-6 py-4 text-xs font-semibold uppercase tracking-wide text-on-accent transition-all hover:brightness-105 active:scale-95"
            ...
            <a
              href="#how"
              className="font-mono rounded-full border border-line-strong px-6 py-4 text-xs font-medium uppercase tracking-wide text-fg-secondary transition-colors hover:border-accent hover:text-accent"
            >
              See how it works
            </a>
          </div>
          ...
          <div className="mt-8 flex flex-wrap gap-5">
            {PROOF.map((p) => (
              <span key={p.l} className="grid gap-0.5">
                <span className="font-display text-2xl font-semibold tracking-tight">{p.n}</span>
        ...
        {/* Demo card */}
        <div
          className="min-w-0 min-w-0 flex-1 basis-96 overflow-hidden rounded-2xl border border-line bg-surface"
          style={{
        ...
        >
          ...
          <div className="p-5 lg:p-7">
            <div className="flex flex-wrap items-baseline justify-between gap-3">
              ...
              <span className="font-mono text-xs font-semibold text-accent">{demoPct}</span>
            </div>
            <div className="my-2.5 mb-1 font-display text-4xl lg:text-5xl font-semibold tracking-tight">
              {demoIncome}
            </div>
            <div className="mb-5 text-sm text-fg-muted">Salary €3,450 · Freelance €850</div>
            ...
            <div className="grid gap-2.5">
              {JARS.map((j) => (
                ...
                >
                  ...
                  <span className="font-mono text-xs font-medium text-fg-faint">{j.pct}%</span>
