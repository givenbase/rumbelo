...
export const LANDING_SECTIONS: LandingSection[] = [
    {
        id: 'header',
        anchor: 'header',
        label: 'Sticky nav + theme + CTA',
        status: 'shell',
        gap: 'Presentational only — no auth routing',
    },
    {
        id: 'hero',
        anchor: 'hero',
        label: 'Hero + floaters + ticker + demo',
        status: 'shell',
    ...
    },
    {
        id: 'coachGlance',
        anchor: 'coach',
        label: 'One glance every morning',
        status: 'shell',
        gap: 'Screenshot placeholder — swap image-slot when ready',
    },
    {
        id: 'whyExists',
        anchor: 'why',
        label: 'Why band quote',
        status: 'shell',
        gap: 'Static copy',
    },
    {
        ...
        status: 'shell',
        gap: 'Presentational — billing toggle is client state only',
    },
    {
        id: 'signup',
        anchor: 'signup',
        ...
        status: 'shell',
        gap: 'Presentational — no backend wired; Better Auth + Stripe to connect',
    },
    {
        id: 'footer',
        anchor: 'footer',
        ...
        status: 'shell',
        gap: 'Placeholder hrefs; swap with real routes',
    },
];
