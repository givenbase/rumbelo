...
/**
 * Remembers a paid pricing CTA (Plus / Max) across marketing → sign-up → verify.
 * Free (Basic) clears intent — no Stripe step after register.
 */
...
/** Optional — returns null outside the provider (e.g. static shells). */
