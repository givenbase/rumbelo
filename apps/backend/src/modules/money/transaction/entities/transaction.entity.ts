 ...
 */
export enum TransactionStatus { INBOX = 'INBOX', SORTED = 'SORTED', IGNORED = 'IGNORED' }
export enum TransactionSource { MANUAL = 'MANUAL', CSV = 'CSV', BANK = 'BANK', RECURRING = 'RECURRING' }
