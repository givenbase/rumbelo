...
export enum RuleField { DESCRIPTION = 'DESCRIPTION', COUNTERPARTY = 'COUNTERPARTY', AMOUNT = 'AMOUNT' }
export enum RuleMatcher { CONTAINS = 'CONTAINS', EQUALS = 'EQUALS', STARTS_WITH = 'STARTS_WITH', REGEX = 'REGEX' }
